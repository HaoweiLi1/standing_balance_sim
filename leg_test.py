...
def controller(model, data):
    ...
    y_perturbation = np.random.normal(loc=2.5, scale=2.5)

    direction_flag = np.random.randint(low=0, high=1)
    ...
    # data.xfrc_applied[1] = [0, y_perturbation, 0., 0., 0., 0.]
